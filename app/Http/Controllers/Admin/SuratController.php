...
class SuratController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $stats = [
            ...
            'menunggu' => PengajuanSurat::whereIn('status', ['diajukan', 'menunggu'])->count(),
            'diproses' => PengajuanSurat::where('status', 'diproses')->count(),
            'revisi' => PengajuanSurat::whereIn('status', ['direvisi', 'revisi'])->count(),
        ...
        // Selalu gunakan admin.dashboard_admin
    ...
    public function process($id)
    {
        ...
        // Validasi: hanya bisa proses jika status masih diajukan/menunggu
        if (!in_array($pengajuan->status, [PengajuanSurat::STATUS_DIAJUKAN, PengajuanSurat::STATUS_MENUNGGU])) {
            return redirect()
    ...
    public function showHistory($id)
    {
        ...
        return view('admin.pengajuan_history_admin', compact('pengajuan', 'history'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.pengajuan_detail_admin', compact('pengajuan'));
    }
    ...
    public function detailRiwayat($id)
    {
        ...
        return view('admin.pengajuan_detail_riwayat_admin', compact('pengajuan', 'allPengajuan', 'history'));
    }
    ...
    public function revise(Request $request, $id)
    {
        ...
        // Validasi: hanya bisa revisi jika status diajukan/menunggu atau diproses
        if (!in_array($pengajuan->status, [PengajuanSurat::STATUS_DIAJUKAN, PengajuanSurat::STATUS_MENUNGGU, PengajuanSurat::STATUS_DIPROSES])) {
            return redirect()
                ->route('admin.dashboard')
