...
@section('title', 'Form Pengajuan - Surat Keterangan Usaha')
                ...
                <div class="flex items-start space-x-6">
                    ...
                    <div class="flex-shrink-0">
                        <div class="w-16 h-16 bg-red-100 rounded-xl flex items-center justify-center">
                            <i class="fas {{ $layanan['icon'] }} text-red-600 text-3xl"></i>
                        </div>
                    </div>
                    <!-- Content -->
                    <div class="flex-1">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">
                                                    Pengantar RT/RW <span class="text-red-500">*</span>
                                                </p>
                                        ...
                                        <label class="ml-4 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors flex-shrink-0">
                                            Choose File
                                            <input type="file" name="doc_pengantar_rt" class="hidden" accept=".pdf,.jpg,.jpeg,.png" 
                                                   required onchange="updateFileName(this, 'file-name-1', true)">
                                        </label>
                                    </div>
                                </div>

                                <!-- 2. Fotokopi Kartu Keluarga (Wajib) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                        ...
                                        <label class="ml-4 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors flex-shrink-0">
                                            Choose File
                                            <input type="file" name="doc_kk" class="hidden" accept=".pdf,.jpg,.jpeg,.png" 
                                                   required onchange="updateFileName(this, 'file-name-2', true)">
                                        </label>
                                    </div>
                                </div>

                                <!-- 3. Fotokopi KTP Pemohon (Wajib) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">
                                                    Fotokopi KTP Pemohon <span class="text-red-500">*</span>
                                                </p>
                                        ...
                                        <label class="ml-4 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors flex-shrink-0">
                                            Choose File
                                            <input type="file" name="doc_ktp_pemohon" class="hidden" accept=".pdf,.jpg,.jpeg,.png" 
                                                   required onchange="updateFileName(this, 'file-name-3', true)">
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <label class="ml-4 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors flex-shrink-0">
                                            Choose File
                                            <input type="file" name="doc_foto_usaha" class="hidden" accept=".pdf,.jpg,.jpeg,.png" 
                                                   required onchange="updateFileName(this, 'file-name-4', true)">
                                        </label>
                                    </div>
                                </div>

                                <!-- 5. Izin Lingkungan (Opsional) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">
                                                    Izin Lingkungan lengkap dengan Fotokopi KTP tetangga yang turut tanda tangan <span class="text-gray-500 text-xs font-normal">(Opsional)</span>
                                                </p>
                                                <p class="text-xs text-gray-500 mt-1">Apabila usaha memiliki dampak kebahayaan bagi lingkungan</p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-5">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="ml-4 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors flex-shrink-0">
                                            Choose File
                                            <input type="file" name="doc_izin_lingkungan" class="hidden" accept=".pdf,.jpg,.jpeg,.png" 
                                                   onchange="updateFileName(this, 'file-name-5', false)">
                                        </label>
                                    </div>
                                </div>

                                <!-- 6. Perjanjian Sewa / Kwitansi (Opsional) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">
                                                    Perjanjian Sewa / Kwitansi <span class="text-gray-500 text-xs font-normal">(Opsional)</span>
                                                </p>
                                                <p class="text-xs text-gray-500 mt-1">Jika lokasi usaha bukan milik sendiri</p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-6">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="ml-4 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors flex-shrink-0">
                                            Choose File
                                            <input type="file" name="doc_sewa" class="hidden" accept=".pdf,.jpg,.jpeg,.png" 
                                                   onchange="updateFileName(this, 'file-name-6', false)">
                                        </label>
                                    </div>
                                </div>

                                <!-- 7. Fotokopi SHM dan Bukti Bayar PBB (Opsional) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">
                                                    Fotokopi SHM dan Bukti Bayar PBB <span class="text-gray-500 text-xs font-normal">(Opsional)</span>
                                                </p>
                                                <p class="text-xs text-gray-500 mt-1">Jika lokasi usaha milik sendiri</p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-7">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="ml-4 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors flex-shrink-0">
                                            Choose File
                                            <input type="file" name="doc_shm_pbb" class="hidden" accept=".pdf,.jpg,.jpeg,.png" 
                                                   onchange="updateFileName(this, 'file-name-7', false)">
                                        </label>
                                    </div>
                                </div>
                            </div>
