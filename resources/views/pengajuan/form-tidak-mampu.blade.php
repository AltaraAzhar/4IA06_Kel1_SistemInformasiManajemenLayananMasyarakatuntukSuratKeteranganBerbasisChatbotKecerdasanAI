...
@section('title', 'Form Pengajuan - Surat Keterangan Tidak Mampu')
                ...
                <div class="flex items-start space-x-6">
                    ...
                    <div class="flex-shrink-0">
                        <div class="w-16 h-16 bg-blue-100 rounded-xl flex items-center justify-center">
                            <i class="fas {{ $layanan['icon'] }} text-blue-600 text-3xl"></i>
                        </div>
                    </div>
                    <!-- Content -->
                    <div class="flex-1">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="border-t pt-6">
                            ...
                            <div class="space-y-4">
                                <!-- Dokumen 1: Pengantar RT/RW (WAJIB) -->
                                ...
                                <!-- Dokumen 2: FC KTP dan KK Pemohon (WAJIB) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">FC KTP dan KK Pemohon</p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-2">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_ktp_kk" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-2')" required>
                                        </label>
                                    </div>
                                </div>

                                <!-- Dokumen 3: Surat Keterangan Rawat Inap (Opsional) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Surat Keterangan Rawat Inap <span class="text-gray-500 font-normal">(jika di pergunakan untuk UHC) - Opsional</span></p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-3">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_rawat_inap" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-3')">
                                        </label>
                                    </div>
                                </div>

                                <!-- Dokumen 4: Surat Keterangan dari Sekolah (Opsional) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Surat Keterangan dari Sekolah <span class="text-gray-500 font-normal">(jika di pergunakan untuk Pengurusan PIP/Keringanan Biaya Sekolah) - Opsional</span></p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-4">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_keterangan_sekolah" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-4')">
                                        </label>
                                    </div>
                                </div>

                                <!-- Dokumen 5: Surat Pernyataan Keluarga Miskin (Opsional) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Surat Pernyataan Keluarga Miskin diketahui RT/RW dan bermaterai cukup <span class="text-gray-500 font-normal">- Opsional</span></p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-5">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_pernyataan_miskin" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-5')">
                                        </label>
                                    </div>
                                </div>
                            </div>
