...
@section('title', 'Form Pengajuan - Surat Keterangan Kematian')
    ...
    <div class="w-full max-w-md bg-white rounded-xl shadow-2xl px-6 py-5 relative">
        ...
        <div class="flex justify-between items-center mt-4">
            <a href="{{ route('user.pengajuan') }}" 
               class="bg-white border border-gray-300 text-gray-600 hover:bg-gray-50 text-sm font-medium rounded-md px-4 py-2 transition-colors">
                Batal
            </a>
            <button type="button" 
                    onclick="closeEtiketModal()"
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-start space-x-6">
                    ...
                    <div class="flex-shrink-0">
                        <div class="w-16 h-16 bg-white/10 rounded-xl flex items-center justify-center">
                            <i class="fas {{ $layanan['icon'] }} text-white text-3xl"></i>
                        </div>
                    </div>
                    <!-- Content -->
                    <div class="flex-1">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="border-t pt-6">
                            ...
                            <div class="space-y-4">
                                <!-- Dokumen 1: Pengantar RT/RW -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Pengantar RT/RW</p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-1">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_pengantar_rt" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-1')" required>
                                        </label>
                                    </div>
                                </div>

                                <!-- Dokumen 2: Fotokopi KTP dan KK Almarhum/Almarhumah -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Fotokopi KTP dan KK Almarhum/Almarhumah</p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-2">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_ktp_kk_alm" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-2')" required>
                                        </label>
                                    </div>
                                </div>

                                <!-- Dokumen 3: Fotokopi KTP dan KK Pelapor -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Fotokopi KTP dan KK Pelapor (jika Pelapor masih dalam 1 KK dengan alm/almh cukup Fotokopi KTP)</p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-3">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_ktp_kk_pelapor" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-3')" required>
                                        </label>
                                    </div>
                                </div>

                                <!-- Dokumen 4: Surat Keterangan Kematian dari Puskesmas/Dokter -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Surat Keterangan Kematian dari Puskesmas/Dokter/Klinik/Rumah Sakit</p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-4">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_surat_kematian" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-4')" required>
                                        </label>
                                    </div>
                                </div>

                                <!-- Dokumen 5: Surat Pernyataan Kematian (Opsional) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Surat Pernyataan Kematian <span class="text-gray-500 font-normal">Jika meninggal di rumah - Opsional</span></p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-5">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_pernyataan_kematian" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-5')">
                                        </label>
                                    </div>
                                </div>

                                <!-- Dokumen 6: Formulir Pelaporan Kematian -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Formulir Pelaporan Kematian</p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-6">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_formulir_kematian" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-6')" required>
                                        </label>
                                    </div>
                                </div>

                                <!-- Dokumen 7: Foto Makam (Opsional) -->
                                <div class="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3 flex-1">
                                            <div class="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                            ...
                                            <div class="flex-1">
                                                <p class="text-sm font-semibold text-gray-900">Foto Makam yang terdapat nisan jika pelaporan lebih dari 1 tahun dan tidak memiliki surat kematian dari Puskesmas/Dokter/Klinik/Rumah Sakit <span class="text-gray-500 font-normal">- Opsional</span></p>
                                                <p class="text-xs text-gray-500 mt-1" id="file-name-7">No file chosen</p>
                                            </div>
                                        </div>
                                        <label class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-md cursor-pointer transition-colors ml-4">
                                            Choose Files
                                            <input type="file" name="doc_foto_makam" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFileName(this, 'file-name-7')">
                                        </label>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
            ...
            <ul class="space-y-2 text-sm text-blue-800">
                ...
                <li class="flex items-start">
                    <i class="fas fa-check-circle mr-2 mt-0.5 text-blue-600"></i>
                    <span>Setelah selesai, download surat (untuk layanan tertentu) atau dapatkan e-tiket dan datang ke kelurahan</span>
                </li>
                <li class="flex items-start">
                    <i class="fas fa-check-circle mr-2 mt-0.5 text-blue-600"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (modal) {
        ...
        // Focus ke modal untuk aksesibilitas
...
function updateFileName(input, targetId) {
    ...
    if (input.files && input.files[0]) {
        ...
        target.classList.add('text-blue-600', 'font-medium');
    } else {
        target.textContent = 'No file chosen';
        target.classList.add('text-gray-500');
        target.classList.remove('text-blue-600', 'font-medium');
    }
}
</script>
