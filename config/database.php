    ...
    */
    'connections' => [
        ...
        */
        'mongodb' => [
            'driver'   => 'mongodb',
            'dsn'      => env('MONGO_URI', env('MONGODB_URI')), // MongoDB Atlas connection string
            'database' => env('DB_DATABASE', 'kelurahan_pabuaran_mekar'),
            
            // Opsi: Jika tidak menggunakan DSN, gunakan konfigurasi berikut:
            // 'host'     => env('DB_HOST', '127.0.0.1'),
